...
from lcer.common.her.replay_memory import HerReplayMemory, SimpleReplayMemory
from lcer.common.utils import hard_update, soft_update
from lcer.her.sac_her_model import DeterministicPolicy, GaussianPolicy, QNetwork


class SAC:
    """
    Soft Actor-Critic reinforcement learning agent.
    Can be used with Hindsight Experience Replay (HER).
    ...
    def save_checkpoint(
        ...
        :param memory: Optional memory-normalizer to be saved
        """
    ...
    def load_checkpoint(self, ckpt_path: str, evaluate: bool = False, load_norm_stats: bool = False) -> dict:
        """
        Load model parameters

        :param ckpt_path: Save path of the checkpoint
        :param evaluate: Whether to load in evaluation mode or training mode
        :param load_norm_stats: Whether to load the memory normalizer stats or not
        :return: Memory normalizer stats
        """
