...
class ValueNetwork(nn.Module):
    """
    Represents a value function V(s)

    :param num_inputs: Dimensions of input features
    :param hidden_dim: Dimensions of hidden features
    """

    def __init__(self, num_inputs: int, hidden_dim: int) -> None:
...
class QNetwork(nn.Module):
    """
    Represents an action-value function Q(s,a)

    :param num_inputs: Dimensions of state features
    :param num_actions: Dimensions of action features
    :param hidden_dim: Dimensions of hidden features
    """
...
class GaussianPolicy(nn.Module):
    ...
    def sample(self, state: torch.Tensor) -> Tuple[torch.Tensor, torch.Tensor, torch.Tensor]:
        """
        Sample an action for a given state

        :param state: Tensor of a transition state
        :returns: The corresponding action, its logarithmic probability and the average value of the distribution
        """
    ...
    def to(self, device: Union[str, torch.device]) -> torch.nn.Module:
